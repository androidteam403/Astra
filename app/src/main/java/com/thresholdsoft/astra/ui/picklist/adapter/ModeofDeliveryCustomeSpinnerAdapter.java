...
public class ModeofDeliveryCustomeSpinnerAdapter  extends BaseAdapter {
    Activity activity;
    List<GetModeofDeliveryResponse.Remarksdetail> remarksdetails;
    LayoutInflater inflter;
    private PickListActivityCallback mListener;

    public ModeofDeliveryCustomeSpinnerAdapter(Activity activity, List<GetModeofDeliveryResponse.Remarksdetail> remarksdetails, PickListActivityCallback mListener) {
