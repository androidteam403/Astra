...
public class ScannedBacodeItemsAdapter extends RecyclerView.Adapter<ScannedBacodeItemsAdapter.ViewHolder> {
    ...
    private AstraMainActivityCallback mainActivityCallback;

    public ScannedBacodeItemsAdapter(Context mContext, List<GetAllocationLineResponse.Allocationdetail> allocationdetailList, AstraMainActivityCallback mainActivityCallback) {
