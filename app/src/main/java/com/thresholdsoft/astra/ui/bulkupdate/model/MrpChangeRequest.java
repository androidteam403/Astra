...
public class MrpChangeRequest implements Serializable {
    ...
    public MrpChangeRequest withDccode(String dccode) {
        this.dccode = dccode;
        return this;
    }
    ...
    public MrpChangeRequest withRequesttype(String requesttype) {
        this.requesttype = requesttype;
        return this;
    }
    ...
    public MrpChangeRequest withUserid(String userid) {
        this.userid = userid;
        return this;
    }
    ...
    public MrpChangeRequest withUpdatetype(String updatetype) {
        this.updatetype = updatetype;
        return this;
    }
    ...
    public MrpChangeRequest withItemdetails(List<Itemdetail> itemdetails) {
        this.itemdetails = itemdetails;
        return this;
    }
